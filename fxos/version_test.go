...
import (
	...
	version "github.com/MaineK00n/go-cisco-version/fxos"
)
...
func TestNewVersion(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			want: version.Version{Major: 7, Minor: 0, Maintenance: 1, Vulnerability: 1},
		},
		{
			name: "7.0(1)1",
			args: args{ver: "7.0(1)1"},
...
func TestVersion_Compare(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			fields: fields{Major: 7, Minor: 0, Maintenance: 1, Vulnerability: 1},
			args:   args{v2: version.Version{Major: 7, Minor: 0, Maintenance: 1, Vulnerability: 1}},
			want:   0,
		},
		{
			name:   "7.0.1 < 7.0.2",
		...
		},
		{
			...
			fields: fields{Major: 7, Minor: 0, Maintenance: 1, Vulnerability: 2},
			args:   args{v2: version.Version{Major: 7, Minor: 0, Maintenance: 1, Vulnerability: 1}},
			want:   +1,
		},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			v1 := version.Version{
				...
				Vulnerability: tt.fields.Vulnerability,
			}
